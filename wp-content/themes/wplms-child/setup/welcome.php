	...
	private function intro() {
		...
		*/
		...
		<p class="wplms-actions">
			...
			<a href="<?php echo esc_url( 'http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/7313-wplms-faqs'); ?>" class="docs button"><?php _e( 'FAQs', 'vibe' ); ?></a>
			<a href="<?php echo esc_url( 'http://vibethemes.com/envato/wplms/documentation/'); ?>" class="docs button"><?php _e( 'Docs', 'vibe' ); ?></a>
			<a href="<?php echo esc_url( 'http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs'); ?>" class="button"><?php _e( 'Customization Tips', 'vibe' ); ?></a>
			<a href="<?php echo esc_url( 'http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/'); ?>" class="button"><?php _e( 'Forums & Support', 'vibe' ); ?></a>
		</p>
	...
	public function install_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						...
						<a href="http://vibethemes.com/envato/wplms/documentation/quick-installation-guide.html#video"><?php _e( 'WPLMS manual installation & setup', 'vibe' ); ?></a><br />
			...
			<div class="return-to-dashboard">
				<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/"><?php _e( 'Unable to setup ? Get help on our Support forums.', 'vibe' ); ?></a>
			</div>
		</div>
		<?php
	}
	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4><?php _e( '27 Bugs fixes and Updates', 'vibe' ); ?></h4>
						<p><?php _e( 'We fixed some pending issues. Refer to change log for complete list of issues/bugs fixed in the update.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/7309-issue-log" class="button"><?php _e( 'Check issue log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4><?php _e( 'Import & Export Update', 'vibe' ); ?></h4>
						<p><?php _e( 'We\'ve added Import & Export feature in the theme. Now you can bulk import questions, users, units, quizzes, assignments or even full courses from your old sites in CSV format.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/13907-update-log-what-features-we-added-in-version-1-7-3" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Import & Export feature', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/import-export.gif'; ?>" /></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/51943-tip-bulk-import-export-wplms-via-csv" class="button" target="_blank"><?php _e('Tutorial','vibe'); ?></a>
					</div>
					<div>
						<h4><?php _e( 'Improved Course Stats', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/course-stats.gif'; ?>" /></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Course Retakes', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/course-retakes.gif'; ?>" /></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/51953-tip-course-re-takes" class="button" target="_blank"><?php _e('Tutorial','vibe'); ?></a>
					</div>
				</div>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Add students by Email', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/students-email.gif'; ?>" /></p>
					</div>
					<div>
						<h4><?php _e( 'Course In-page Curriculum', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/course-curriculum.gif'; ?>" /></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/51954-tip-lms-settings-with-popular-tips" class="button" target="_blank"><?php _e('Tutorial','vibe'); ?></a>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Course Accordion', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/course-accordion.gif'; ?>" /></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/51954-tip-lms-settings-with-popular-tips" class="button" target="_blank"><?php _e('Tutorial','vibe'); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						<h4><?php _e( 'WPLMS Coauthors Plus addon Updated', 'vibe' ); ?></h4>
						<p><?php _e( 'Coauthors Plus addon has been updated with two important fixes. You need to re-download the plugin, delete the existing one and upload the new one to update the plugin.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/25447-tip-wplms-coauthor-plus-integration" class="button"><?php _e( 'Download', 'vibe' ); ?></a>
					</div>
					<div>
						<h4><?php _e( 'Updated WPLMS Course Statuses', 'vibe' ); ?></h4>
						<p><?php _e( 'WPLMS now supports custom course status values for courses. Custom Course statuses would be helpful in adding custom functionility in the theme. Refer below link for one such example. ', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/48401-tip-adding-custom-course-statuses-in-wplms" class="button"><?php _e( 'Tutorial', 'vibe' ); ?></a>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Translation Collaboration', 'vibe' ); ?></h4>
						<p><?php _e( 'Let me admit, it is a cumbersome task to maintain translation files. Therefore we\'re asking for the WPLMS community to participate. Check the below link and participate in the WPLMS Google Translation project.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/10250-translation-files-in-wplms-package"><?php _e( 'Link for invitation','vibe'); ?></a>
					</div>
				</div>
			</div>
			<div class="return-to-dashboard">
