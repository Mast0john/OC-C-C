...
<div class="course_title">
	<h2><?php  _e('Programme formation','vibe'); ?></h2>
</div>
	...
	foreach($course_curriculum as $lesson){
		if(is_numeric($lesson)){
			...
			echo '<div class="course_lesson">
					...
					echo apply_filters('wplms_curriculum_time_filter','<span><i class="icon-clock"></i> '.(isset($hours)?$hours.__(' Heures','vibe'):'').' '.$minutes.' '.__('minutes','vibe').'</span><b>'.((isset($hours) && $hours)?$hours:"00").':'.$minutes.'</b>',$min);
					}	
