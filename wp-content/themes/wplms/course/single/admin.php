...
<div class="item-list-tabs no-ajax " id="subnav" role="navigation">
	<ul>
		<li class="course_sub_action <?php if(!isset($_GET['soumissions']) && !isset($_GET['stats']) && !isset($_GET['activité'])) echo 'current'; ?>">
			<a id="course_members" href="?action=admin"><?php _e('Membres','vibe'); ?></a>
		</li>	
		<li class="course_sub_action <?php if(isset($_GET['soumissions'])) echo 'current'; ?>">
			<a id="course_submissions" href="?action=admin&submissions"><?php _e('Soumissions','vibe'); ?></a>
		</li>
		<li class="course_sub_action <?php if(isset($_GET['activité'])) echo 'current'; ?>">
			<a id="course_activity" href="?action=admin&activity"><?php _e('Activité','vibe'); ?></a>
		</li>
...
if(isset($_GET['activity'])){
	...
	locate_template( array( 'formation/single/activity.php'  ), true );

}else if(isset($_GET['submissions'])){

locate_template( array( 'formation/single/submissions.php'  ), true );

}else if(isset($_GET['stats'])){

	locate_template( array( 'formation/single/stats.php'  ), true );
}else{
...
?>	
	<h4 class="total_students"><?php _e('Nombre total de participants en formation','vibe'); ?><span><?php echo $students; ?></span></h4>
	<h3><?php _e('Participants actuels à cette formation','vibe'); ?></h3>
	<?php
