                    ...
                    <div class="content">
                        <div id="assignment" class="main_content">
                            ...
                            switch($flag){
                                ...
                                echo '<a class="button right" id="clear_previous_submissions" data-id="'.get_the_ID().'" data-security="'.wp_create_nonce('user'.$user_id).'">'.__('CLEAR PREVIOUS SUBMISSIONS','vibe').'</a>';
