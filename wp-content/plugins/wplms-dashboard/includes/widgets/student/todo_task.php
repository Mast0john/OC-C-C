...
class wplms_dash_tasks extends WP_Widget {
    ...
    $this->WP_Widget( 'wplms_dash_tasks', __(' DASHBOARD : To Do Tasks', 'wplms-dashboard'), $widget_ops, $control_ops );
    ...
    function save_tasks(){
      ...
      if ( !isset($_POST['security']) || !wp_verify_nonce($_POST['security'],'vibe_security')){
             _e('Security issue.','wplms-dashbaord');
             die();
        }
