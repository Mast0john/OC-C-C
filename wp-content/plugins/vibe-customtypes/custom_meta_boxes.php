	...
	switch($metabox){
		case 'post':
	     ...
	     $prefix.'template'=>array( // Single checkbox
	        ...
	        'options' => array(
	                    1=>array('label'=>__('Content on Left','vibe'),'value'=>''),
	                    2=>array('label'=>__('Content on Right','vibe'),'value'=>'right'),
	                    3=>array('label'=>__('Full Width','vibe'),'value'=>'full'),
	        ),
	        'std'   => ''
		),
		...
		case 'popup':
			$metabox_settings = array(  
				...
				'desc'	=> __('Set Maximum width of popup','vibe' ), // description
				...
				'desc'	=> __('Set Maximum height of popup ','vibe' ), // description
				...
				array( // Text Input
				'label'	=> __('Custom Class','vibe-customtypes'), // <label>
				'desc'	=> __('Add custom class to popup ','vibe' ), // description
