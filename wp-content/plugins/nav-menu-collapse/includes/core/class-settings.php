...
final class Nav_Menu_Collapse_Settings extends Nav_Menu_Collapse_Wrapper
{
	...
	public function load_settings_page()
	{
		...
		add_action('admin_enqueue_scripts', array('Nav_Menu_Collapse_Global', 'admin_enqueue_scripts'), 100);
	...
	{
		array_unshift($links, '<a href="' . get_admin_url(null, 'options-general.php?page=' . Nav_Menu_Collapse_Constants::OPTION_SETTINGS) . '" class="dashicons-before dashicons-admin-tools">' . $this->page_title . '</a>');
