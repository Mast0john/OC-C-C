	...
	public static function output($kb_path, $plugin_page = true)
	{
		...
		)
		{
			...
			if ($plugin_page === true)
			{
				...
				. '<hr />'
				. '<p><a href="' . Nav_Menu_Collapse_Constants::URL_SUPPORT . '" target="_blank" rel="noopener noreferrer" class="button">' . __('Plugin Support', 'nav-menu-collapse') . '</a></p>'
				. '<p><a href="' . Nav_Menu_Collapse_Constants::URL_REVIEW . '" target="_blank" rel="noopener noreferrer" class="button">' . __('Review Plugin', 'nav-menu-collapse') . '</a></p>'
				. '<p><a href="' . Nav_Menu_Collapse_Constants::URL_TRANSLATE . '" target="_blank" rel="noopener noreferrer" class="button">' . __('Translate Plugin', 'nav-menu-collapse') . '</a></p>'
				. '<p><a href="' . Nav_Menu_Collapse_Constants::URL_DONATE . '" target="_blank" rel="noopener noreferrer" class="button">' . __('Plugin Donation', 'nav-menu-collapse') . '</a></p>');
			}
