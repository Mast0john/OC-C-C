	...
	public static function side_meta_boxes()
	{
		...
		(
			...
			(
				...
				(
					...
					. '<a href="https://robertnoakes.com/" target="_blank" rel="noopener noreferrer"><img src="' . $nmc->cache->asset_path('images', 'robert-noakes.png') . '" height="62" width="514" alt="Robert Noakes" /></a>'
				)),
				
				new Nav_Menu_Collapse_Field_HTML(array
				(
					'content' => '<strong>' . __('Knowledge base available on', 'nav-menu-collapse') . '</strong><br />'
					. '<a href="' . Nav_Menu_Collapse_Constants::URL_KB . '" target="_blank" rel="noopener noreferrer"><img src="' . $nmc->cache->asset_path('images', 'noakes-plugins.png') . '" height="75" width="514" alt="Noakes Plugins" /></a>'
				)),
				
				new Nav_Menu_Collapse_Field_HTML(array
				(
					'content' => __('Running into issues with the plugin?', 'nav-menu-collapse') . '<br />'
					. '<a href="' . Nav_Menu_Collapse_Constants::URL_SUPPORT . '" target="_blank" rel="noopener noreferrer"><strong>' . __('Submit a ticket.', 'nav-menu-collapse') . '</strong></a>'
				)),
				
				new Nav_Menu_Collapse_Field_HTML(array
				(
					'content' => __('Have some feedback you\'d like to share?', 'nav-menu-collapse') . '<br />'
					. '<a href="' . Nav_Menu_Collapse_Constants::URL_REVIEW . '" target="_blank" rel="noopener noreferrer"><strong>' . __('Provide a review.', 'nav-menu-collapse') . '</strong></a>'
				)),
				
				new Nav_Menu_Collapse_Field_HTML(array
				(
					'content' => __('Want to see the plugin in your language?', 'nav-menu-collapse') . '<br />'
					. '<a href="' . Nav_Menu_Collapse_Constants::URL_TRANSLATE . '" target="_blank" rel="noopener noreferrer"><strong>' . __('Assist with translation.', 'nav-menu-collapse') . '</strong></a>'
				)),
				...
				(
					...
					(
						...
						'<a href="' . Nav_Menu_Collapse_Constants::URL_DONATE . '" target="_blank" rel="noopener noreferrer">' . __('make a donation', 'nav-menu-collapse') . '</a>'
					)
					. '</strong>'
				))
			)
		...
		(
			...
			(
				new Nav_Menu_Collapse_Field_HTML(array
				(
					'content' => '<a target="_blank" href="https://shareasale.com/r.cfm?b=1144535&amp;u=1815763&amp;m=41388&amp;urllink=&amp;afftrack=" rel="noopener noreferrer">'
