    ...
    class WPLMS_Assignments
    {
       ...
       function mynotice(){
        ...
        public function displayFormAtt(){   
            ...
            echo '<p class="assignment_submission"><strong>'.__('RECENTLY UPLOADED','vibe').' : </strong><a class="attachmentLink" target="_blank" href="'.$att.'">'.$attachmentName.'</a><a id="clear_previous_submissions" data-id="'.get_the_ID().'" data-security="'.wp_create_nonce('user'.$user_id).'"><i class="icon-x"></i></a></p>';
            }


            echo '<p class="comment-form-url comment-form-attachment">
                    <input id="attachment" name="attachment" type="file" /></p>';
